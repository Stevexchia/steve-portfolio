...
import projectImage2 from "../assets/weatherforecast.png";
...
export const ABOUT = [
  "A Computer Engineering student with a passion for exploring how technology can solve real-world problems. Whether it's through coding, systems design, or tackling technical challenges, I’m driven by the potential to create innovative solutions. I have a particular interest in areas that promote inclusivity and accessibility, which fuels my curiosity and dedication to learning and developing impactful projects.",
  "When I'm not on my computer, I love going to the gym, playing sports, and connecting with people. Hearing stories inspires me, as I believe there’s unique value in everyone. I’m always excited to contribute, grow, and learn from the experiences and insights others bring."
];
...
export const EDUCATION = [
  ...
  },
  {
    ...
    duration: "2019 - 2020",
    description:
      "Completed studies in the PCME (Physics, Chemistry, Mathematics, and Economics) stream, emphasizing analytical and quantitative skills. Participated in advanced mathematical competitions and collaborative projects, fostering a strong foundation in scientific principles and problem-solving methodologies.",
  },
];
...
export const PROJECTS = [
  ...
  },
  {
    ...
    name: "Alex",
    description:
      "Alex locates survivors in tough environments. It uses LiDAR for mapping, powered by Arduino and Raspberry Pi 3, along with wheel encoders, a color sensor, and a buzzer to assist in rescue missions.",
    image: projectImage5,
